...
require (
	...
	github.com/appscode/osm v0.0.0-20181204132028-fb08059eb926
	...
	github.com/operator-framework/operator-marketplace v0.0.0-20231108032947-8304276818ba
...
replace (
	...
	k8s.io/client-go => k8s.io/client-go v0.26.0 // Required by prometheus-operator
